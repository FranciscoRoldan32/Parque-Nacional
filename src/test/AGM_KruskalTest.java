...
public class AGM_KruskalTest {
	private GraphService graph = new GraphService();
	private AlgorithmsServicesKruskal kruskalService;
	...
	public void setUp() {
		...
		kruskalService = new AlgorithmsServicesKruskal(graph.getGraph());
	}

	@Test
    public void testMinimumSpanningTreeKruskal() {
        List<Edge> mst = kruskalService.getMinimumSpanningTreeKruskal();
